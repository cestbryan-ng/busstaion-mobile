    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.description, { color: theme.textStrong }]}>
          Comparez les trajets de vos agences préférées, choisissez votre siège
          sur un plan interactif et achetez votre billet en toute sécurité. Fini
          les files d'attente !
        </Text>
      </View>
      ...
      <View style={styles.footer}>
        ...
        >
          <Image
            source={
              isDark
                ? require('../../assets/images/onboard2_vector_dark.png')
                : require('../../assets/images/onboard2_vector_light.png')
            }
