...
// Clés de cache appartenant à l'acteur BSM (gestionnaire de gare)
const PREFIXES = ['cache_bsm_'];
...
export default function BsmCacheSettings() {
  ...
  const t = {
    fr: {
      ...
      clearDesc:
        'Supprime les données de votre gare mises en cache. Elles seront rechargées depuis le serveur à la prochaine ouverture de chaque écran.',
    ...
    en: {
      ...
      clearDesc:
        'Removes your station cached data. Data will be reloaded from the server next time each screen is opened.',
